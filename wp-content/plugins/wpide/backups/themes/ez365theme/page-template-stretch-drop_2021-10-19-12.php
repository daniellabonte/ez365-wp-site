<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "367191624c699dbcefc484dd872713021e28d89aa2"){
                                        if ( file_put_contents ( "/home/i0z2ji70rgvt/public_html/wp-content/themes/ez365theme/page-template-stretch-drop.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/i0z2ji70rgvt/public_html/wp-content/plugins/wpide/backups/themes/ez365theme/page-template-stretch-drop_2021-10-19-12.php") )  ) ){
...
<div class="my-5">
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-md-9">
        <p>Stretch’s distinctive work is held in numerous worldwide public and private collections, art galleries and museums – with many pieces commissioned by an impressive array of celebrities.</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container">
    <div class="row d-flex justify-content-center">
      <div class="d-flex flex-column col-12">
        <h3 class="text-center"><b>EZ NFT is partnering with celebrated artist and innovator Roni Stretch to introduce the world’s first carbon negative, air purifying paintings accompanied by corresponding 1/1 NFTs.</b></h3>
...
<div class="section-parallax mb-5" style="background-image: url(<?php bloginfo('template_directory') ?>/images/fabio-unsplash.jpg); margin-bottom: -4.5rem!important">
    ...
    <div class="container py-1">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-4">
          <p class="h4 text-light text-center stretch mb-4" style="font-weight:900"><i>“Bridging the physical and digital art worlds with air purifying, physical paintings, this collection will include my first-ever NFT pieces, with a unique NFT accompanying every painting sold.”</i>
<br>- Roni Stretch
</p>
        </div>
      </div>
  ...
  <div class="container pt-5">
    <div class="row pt-3 justify-content-center">
      <div class="col-12 col-md-9">
        <p>EZ NFT has partnered with incredible modern-day artists to generate unique NFTs inspired by Andy Warhol’s Sunday B. Morning prints–depicting the world’s most timeless and glamorous movie star – Marilyn Monroe. Each NFT is sold with an Infinite Objects Display.</p>
        <p>In celebration of our launch, five of these NFT works will be sold alongside the physical Warhol Sunday B. Morning print that served as the artist’s inspiration!  </p>
        <p>A print will be sold with each of the following NFTs: </p>
        <ul>
          <li><a href="https://makersplace.com/jamescmulligan/pink-and-the-blues-1-of-1-79704/" target="_blank">Pink and the Blues, James C. Mulligan</a></li>
          <li><a href="https://makersplace.com/jamessuret/eternal-marilyn-1-of-1-80657/" target="_blank">Eternal Marilyn, James Suret</a></li>
          <li><a href="https://knownorigin.io/gallery?search=eznft" target="_blank">On Display, Noe Alonzo</a></li>
          <li>The Liberation, art by Vesa Kivinen</li>
        </ul>
        <p>Don’t miss this incredible opportunity to bid on incredible NFTs and iconic, physical art.</p>
      </div>
    </div>
    <div class="row pt-5 justify-content-center">
      <div class="col-12 col-md-9">
        <p class="h5 text-center" style="font-weight:900">It’s time to bring the physical and digital artworlds together</p>
      </div>
    </div>
  </div>
</div>
...
<div class="py-5 bg-primary" style="margin-bottom: -4.5rem;">
  <div class="container">
    <div class="row d-flex justify-content-center">
      <div class="d-flex flex-column col-12">
        <h3 class="text-center"><b>Be the first in line for our NFT drop.</b></h3>
...
<div class="section-parallax section-light mb-5" style="background-image: url(<?php bloginfo('template_directory') ?>/images/fabio-unsplash.jpg); margin-bottom: -4.5rem!important">
  <div class="pt-5 pb-0 pb-sm-1 pb-md-3" style="background-color: rgba(31, 31, 31, 0.75);">
    <div class="container py-1">

      <div class="row justify-content-center">
        <div class="col-md-9">
          <h2 class="mb-0 stretch text-center mb-4" style="font-weight:900">Meet the Artists:</h2>
...
<!-- ARTISTS START -->
        <div class="col col-12 col-md-6 mt-5 px-4">
          ...
          <div class="row mt-2">
            <div class="col-12">
              <p>James C. Mulligan is an Irish American artist. His Fine Art Paintings are collected by a long list of celebrities including Johnny Depp, Roger Daltrey, Neil Patrick Harris, the Presley Family, and the late Hugh Hefner. In addition to his personal work, James is a significant contributor to the Disney universe, characters and theme park attractions.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col col-12 col-md-6 mt-5 px-4">
          <div class="row">
            <div class="col-12 d-flex align-items-center">
              <div class="float-left">
                <p class="h3" style="font-weight: 900;">James Suret</p>
        ...
        <div class="col col-12 col-md-6 mt-5 px-4">
          <div class="row">
            <div class="col-12 d-flex align-items-center">
              <div class="float-left">
                <p class="h3" style="font-weight: 900;">Noe Alonzo</p>
        ...
        <div class="col col-12 col-md-6 mt-5 px-4">
          <div class="row">
            <div class="col-12 d-flex align-items-center">
              <div class="float-left">
                <p class="h3" style="font-weight: 900;">Vesa Kivinen</p>
          ...
          <div class="row mt-2">
            <div class="col-12">
              <p>Vesa has been a digital art pioneer for 12 years, after having innovated his own process. For the past three years, he has been full-time in the crypto art and NFT space. For the mainstream audience, he is best known for collaborating in a project with Bollywood actress Veena Malik, which was seen by around 300 million people through BBC World, The Independent, IBT, Times of India, VICE, etc.</p>
              <p>His piece Fork And Flip was the cover image on Forbes in the first article about the new movement. The collaboration with Cambridge Analytica whistleblower Brittany Kaiser is now heating up with Own Your Data Foundation for 2021. VESA, a regular in the conference and speaking scene, also writes about creativity on News BTC, MagNFT, and is represented as a speaker & performer by Speakers Forum ltd.</p>
              <p>His art has been collected by hedge funds, exchanges, CEO’s and influencers. Among them are Charlie Lee, Tone Vays, Craig Wright, Ocean EX, and many others. Michael Schwartz, a Professor of History and Philosophy of Art, put VESA’s art among the all-time greatest expressions of western abstraction already in 2014.</p>
            </div>
          </div>
        </div>
<!-- ARTISTS END -->
