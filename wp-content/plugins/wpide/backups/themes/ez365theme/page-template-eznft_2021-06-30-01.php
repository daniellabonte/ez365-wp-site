<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "367191624c699dbcefc484dd87271302e5a394bba8"){
                                        if ( file_put_contents ( "/home/i0z2ji70rgvt/public_html/wp-content/themes/ez365theme/page-template-eznft.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/i0z2ji70rgvt/public_html/wp-content/plugins/wpide/backups/themes/ez365theme/page-template-eznft_2021-06-30-01.php") )  ) ){
      ...
      <div class="row px-4 p-2 my-5 mx-1" style="border: solid white 2px; background-color: #00000066">
        ...
        <div class="col-md-6 my-4">
          ...
          <a href="./ren2" class="text-secondary">
            ...
            <p class="h5">Learn more about Renaissance 2.0</p>
          </a>
        </div>
      </div>
