<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "367191624c699dbcefc484dd8727130224f5dac0b2"){
                                        if ( file_put_contents ( "/home/i0z2ji70rgvt/public_html/wp-content/themes/ez365theme/page-template-renaissance.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/i0z2ji70rgvt/public_html/wp-content/plugins/wpide/backups/themes/ez365theme/page-template-renaissance_2021-06-09-12.php") )  ) ){
...
<div class="pt-5 my-5">
  <div class="container">
    ...
    <div class="row mt-5">
      <p class="text-center">Note: The auction winner retains the right to split up the set by selling the physical artwork and keeping the NFT, or vice versa.</p>
    </div>
  </div>
</div>
