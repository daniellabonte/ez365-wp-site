<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "367191624c699dbcefc484dd872713026b49964b6c"){
                                        if ( file_put_contents ( "/home/i0z2ji70rgvt/public_html/wp-content/themes/ez365theme/page-template-stretch-drop.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/i0z2ji70rgvt/public_html/wp-content/plugins/wpide/backups/themes/ez365theme/page-template-stretch-drop_2021-10-18-21.php") )  ) ){
    ...
    <div class="container py-1">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-4">
          <p class="h4 text-light text-center stretch mb-4" style="font-weight:900">“Bridging the physical and digital art worlds with air purifying, physical paintings, this collection will include my first-ever NFT pieces, with a unique NFT accompanying every painting sold.”
<br><i>- Roni Stretch</i>
</p>
        </div>
      </div>
