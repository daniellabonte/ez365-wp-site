<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "367191624c699dbcefc484dd87271302e18e535fe2"){
                                        if ( file_put_contents ( "/home/i0z2ji70rgvt/public_html/wp-content/themes/ez365theme/page-template-featured-drops.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/i0z2ji70rgvt/public_html/wp-content/plugins/wpide/backups/themes/ez365theme/page-template-featured-drops_2021-10-12-14.php") )  ) ){
  ...
  <div class="container">
    <div class="row d-flex justify-content-center">
      <div class="d-flex flex-column col-12">
        <h3 class="text-center"><b>Be the first in line for our next NFT drop.</b></h3>
...
<div class="section-parallax mb-5" style="background-image: url(<?php bloginfo('template_directory') ?>/images/fabio-unsplash.jpg); margin-bottom: -4.5rem!important">
  <div class="pt-5 text-center pb-0 pb-sm-1 pb-md-3" style="background-color: rgba(31, 31, 31, 0.75);">
    <div class="container py-1">
      ...
      <div class="row">
        <div class="col-md-12">
          <h2 class="mb-0 text-white stretch" style="font-weight:900">EZ NFT</h2>
        </div>
      </div>
      ...
      <div class="row mb-5">
        <div class="col-md-12 text-light text-center">
          <p class="p-0 mx-5 mb-3 h5">Embrace the new art paradigm</p>
