...
<div class="py-5 text-center section-parallax" style="background-image: url(<?php bloginfo('template_directory') ?>/images/fabio-unsplash.jpg); margin-bottom: -4.5rem!important">
  <div class="container py-1">
    ...
    <div class="row px-4 p-2 my-5" style="border: solid white 2px; background-color: #00000066">
      ...
      <div class="col-md-6 my-4">
        <p class=" mb-0 text-white"><b>Coming soon!</b> EZ 365 will be hosting an exciting series of art auctions beginning in X. New and existing art collectors alike will be blown away by the quality and esteem of the coming art pieces. Mark your calendars and stay tuned for important updates on this once-in-a-lifetime opportunity.</p>
      </div>
    </div>
